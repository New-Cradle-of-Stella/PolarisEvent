...
";
        ...
        public void UnemittedStaticDiagnosticsAreExactlyTheOnesDeferredToLaterStages()
        {
            var expected = new HashSet<string>
            {
                ...
                // 功能阶段 E：异步调用的语义检查、exec 参数类型。集合等待的句柄/绑定规则
                // （7219/7221/7223/7224）已经在绑定器里发射；7225 需要一个"当前表达式是不是
                // 直接的语句或初始化器"的位置标记，那份标记随阶段 E 的 callevt/exec 一并引入。
                "PEVT7203", "PEVT7225", "PEVT7403",
